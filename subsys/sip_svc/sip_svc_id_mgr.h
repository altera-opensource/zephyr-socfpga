...
#ifndef ZEPHYR_SERVICE_SIP_SVC_ID_MGR_H_
#define ZEPHYR_SERVICE_SIP_SVC_ID_MGR_H_
...
int sip_svc_id_map_insert_item(struct sip_svc_id_map *id_map,
				uint32_t id,
				void *arg1,
				void *arg2,
				void *arg3,
...
int sip_svc_id_map_remove_item(struct sip_svc_id_map *id_map,
				uint32_t id);

struct sip_svc_id_map_item *sip_svc_id_map_query_item(
				struct sip_svc_id_map *id_map,
				uint32_t id);

#endif /* ZEPHYR_SERVICE_SIP_SVC_ID_MGR_H_ */
